...
type
  // FNCloseCheckEx3
  TParserCommandFF76 = class(TParserCommand)
  public
...
procedure TParserCommandFF76.CreateAnswerFields;
begin
//Сдача (5 байт)
//Номер ФД (4 байта)
...
procedure TParserCommandFF76.CreateFields;
begin
...
function TParserCommandFF76.GetShortValue: string;
begin
  Result := Format('ЗАКРЫТИЕ ЧЕКА V3 [ДОК: %s] [ФП: %s]  ', [
